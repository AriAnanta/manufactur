...
import ProductionPlans from './pages/production-planning/ProductionPlans';
import PlanDetail from './pages/production-planning/PlanDetail';
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        <Routes>
          ...
          <Route element={<ProtectedRoute><MainLayout /></ProtectedRoute>}>
            ...
            <Route path="/production-requests/:id" element={<ProductionRequestDetail />} />
            ...
            <Route path="/production-plans/:id" element={<PlanDetail />} />
