...
const StatusChip = ({ status }) => {
  const statusConfig = {
    ...
    PENDING_APPROVAL: { color: "warning", label: "Pending Approval", bgcolor: "#fff3e0" },
                ...
                <Table sx={{ minWidth: 800 }}>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell sx={{ fontWeight: 600, py: 2 }}>Planned Start Date</TableCell>
                      <TableCell sx={{ fontWeight: 600, py: 2 }}>Planned End Date</TableCell>
                          ...
                          >
                            ...
                            <TableCell sx={{ py: 2 }}>
                              <Chip 
                                ...
                                size="small"
                                color={
                                  plan.priority === 'urgent' ? 'error' :
                                  plan.priority === 'high' ? 'warning' :
                                  plan.priority === 'normal' ? 'info' : 'success'
                                }
                                sx={{ fontWeight: 500 }}
                              />
                            </TableCell>
