...
app.use(
  ...
  createHandler({
    schema: schema,
    rootValue: root,
    // graphql-http tidak menyediakan graphiql, jika diperlukan, gunakan paket terpisah
  })
);

// GraphQL Playground endpoint untuk diuji dengan Apollo
...
async function startServer() {
  try {
    ...
    const server = app.listen(PORT, () => {
      ...
      console.log(`🎮 GraphQL Playground (Apollo): http://localhost:${PORT}/playground`);
    });
